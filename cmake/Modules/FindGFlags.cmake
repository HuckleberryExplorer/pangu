# This file is used to find gflags library in CMake script, based on code from
#
...
# * Try to find GFLAGS
#
# The following variables are optionally searched for defaults GFLAGS_ROOT_DIR:
# Base directory where all GFLAGS components are found
#
...
if(MSVC)
  ...
  find_library(GFLAGS_LIBRARY gflags
               HINTS "${CMAKE_PREFIX_PATH}/gflags/2.2.2/lib")
endif()
...
if(GFLAGS_FOUND)
  ...
  message(
    STATUS
      "Found gflags  (include: ${GFLAGS_INCLUDE_DIR}, library: ${GFLAGS_LIBRARY})"
  )
  mark_as_advanced(GFLAGS_LIBRARY_DEBUG GFLAGS_LIBRARY_RELEASE GFLAGS_LIBRARY
                   GFLAGS_INCLUDE_DIR GFLAGS_ROOT_DIR)
endif()
